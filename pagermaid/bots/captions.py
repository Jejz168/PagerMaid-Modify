...
@listener(is_plugin=False, incoming=True, command="convert",
...
@listener(is_plugin=False, incoming=True, command="caption",
...
@listener(is_plugin=False, incoming=True, command='ocr',
...
@listener(is_plugin=False, incoming=True, command='highlight',
