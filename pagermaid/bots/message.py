...
@listener(is_plugin=False, incoming=True, command="id",
...
@listener(is_plugin=False, incoming=True, owners_only=True, command="uslog",
...
@listener(is_plugin=False, incoming=True, owners_only=True, command="log",
...
@listener(is_plugin=False, incoming=True, command="re",
...
@listener(is_plugin=False, incoming=True, owners_only=True, command="leave",
...
@listener(is_plugin=False, incoming=True, command="meter2feet",
...
@listener(is_plugin=False, incoming=True, command="feet2meter",
...
@listener(is_plugin=False, incoming=True, command="hitokoto",
